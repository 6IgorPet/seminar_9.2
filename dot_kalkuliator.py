...
BOT_TOKEN = '5644910663:AAHu8Bm3BDEj6zzeu9ubzthqjLzVIOHCAlA' # Токен Телеграм-бота
BOT_NAME = 'Igor1983_bot' # Имя для бота. Нужно в том случае, если вы хотите обращаться к боту по имени
